...
For each record of the raw data it is provided:
======================================
...
Tidy data set variables decription:
======================================

There are 563 variables and 10299 observations.

Column 1. Subject: 
Each row identifies the subject who performed the activity for each window sample. Its range is from 1 to 30.

Column 2. Activity: It is codified as:
...
Columns 3-563. Features selected from the accelerometer and gyroscope 3-axial raw signals tAcc-XYZ and tGyro-XYZ
